...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split_3x6_3(
      ...
      * ├────┼──────┼──────┼─────────┼─────────┼──────────┤       ├──────┼──────┼──────┼───────┼──────┼───┤
      * │    │ HOME │ END  │ BRIGHT^ │ BRIGHTv │ CTRL+OPT │       │ Left │ Down │ Up   │ Right │ Del  │   │
      * ├────┼──────┼──────┼─────────┼─────────┼──────────┤       ├──────┼──────┼──────┼───────┼──────┼───┤
    ...
    [2] = LAYOUT_split_3x6_3(
      ...
      //--------------------------------------------------------------         ---------------------------------------------------------------------------------
        KC_NO,   KC_HOME,    KC_END,    KC_BRMD,  KC_BRMU,  C(KC_LOPT),         KC_LEFT,    KC_DOWN,   KC_UP,    KC_RGHT,    KC_DEL,   KC_NO,
      //--------------------------------------------------------------         ---------------------------------------------------------------------------------
        KC_LSFT,  G(KC_Z),    G(KC_X),    G(KC_C),  G(KC_V),  KC_APP,           KC_VOLD,    KC_VOLU,   KC_MUTE,    KC_NO,      KC_NO,  KC_RSFT,
      //--------------------------------------------------------------         ---------------------------------------------------------------------------------
